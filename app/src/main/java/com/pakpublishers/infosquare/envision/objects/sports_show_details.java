...
public class sports_show_details {
    ...
    public void parse(JSONObject ch) throws JSONException {
        ...
        try {
            setLive_url(ch.get("live_url").toString());
        } catch (Exception er) {
        }
        try {
            setLive_url_ios(ch.get("live_url_ios").toString());
        } catch (Exception er) {
        }
        try {
        ...
        try {
            setTeam1_url(ch.get("team1_url").toString());
        } catch (Exception er) {
        }
        try {
        ...
        try {
            setTeam2_url(ch.get("team2_url").toString());
        } catch (Exception er) {
        }
        try {
